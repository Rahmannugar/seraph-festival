            ...
            <div id="leftBox" className="lg:w-1/2  box-border">
              ...
              >
                <h1 className="md:text-3xl lg:text-5xl text-xl uppercase font-black py-3 lg:mt-[-100px]">
                  Seraph Christian Festival: A Celebration of Faith and
                  Community.
                </h1>
                <p className="text-sm mt-10">
                  ...
                  community, bringing together individuals from all walks of
                  life to unite in worship, fellowship, and joy. Immerse
                  yourself in inspiring worship sessions, engaging speakers,
                  uplifting music, and activities that strengthen your faith and
                  connect you with like-minded believers. Whether you're seeking
                  spiritual growth, looking to connect with fellow Christians,
                  or simply yearning for a day of faith-filled celebration, the
                  Seraph Christian Festival is the place to be. Come, be a part
                  of this transformative event and let your faith soar with the
                  seraphic spirit!
                </p>
              </div>
            </div>
                ...
                <li className="mb-5 lg:flex lg:space-x-3">
                  ...
                  >
                    ...
                    <p className="text-xs mb-3">
                      ...
                      community through a day of fun activities, gifts, and
                      emotional support. We will provide a memorable experience
                      for them while raising awareness about the needs of
                      orphanage homes. The event encourages volunteerism and
                ...
                <li className="mb-5 lg:flex lg:space-x-3">
                  ...
                  >
                    ...
                    <p className="text-xs mb-3">
                      ...
                      incarcerated, providing support, empathy, and a sense of
                      hope. Through meaningful interactions, motivational talks,
                      and acts of kindness, we aim to bring a glimmer of
                      positivity to the lives of the inmates. Join us in
                      fostering a sense of rehabilitation, second chances, and
                      community reintegration, as we strive to make a difference
                      in the lives of those within Kirikiri prison.
                    </p>
                    <div className="flex items-center justify-center"></div>
                  </div>
                </li>
                ...
                <li className="mb-5 lg:flex lg:space-x-3">
                  ...
                  >
                    ...
                    <p className="text-xs mb-3">
                      ...
                      quality healthcare, and this event is designed to provide
                      just that. Our team of dedicated healthcare professionals
                      will offer a range of medical services, from general
                      checkups to specialized screenings, all completely free of
                      charge. Whether you're seeking a routine health assessment
                      or have specific concerns, our event aims to promote
                      preventive care and early detection while fostering a
                      healthier community.
                    </p>
                    <div className="flex items-center justify-center"></div>
                  </div>
                ...
                <li className="mb-5 lg:flex lg:space-x-3">
                  ...
                  >
                    ...
                    <p className="text-xs mb-3">
                      ...
                      Come together with fellow believers to worship, connect,
